...
color_list = [((sin(0.39+2*pi*k/num_of_col_f)+1)/2, (cos((2*pi*k/num_of_col_f)+0.39)+1)/2, 0.5) | k <- [1..num_of_col_f] ]
...
--init_color :: t -> [t1] -> [a]
init_color _ [] = []
init_color n ((Attributes (t0,t1,t2,t3,t4,t5,t6,_)):xs) = (Attributes (t0,t1,t2,t3,t4,t5,t6,(ran_number n))):(init_color (n-1) xs)
